...
class GazeboConnection():
    ...
    def __init__(self, start_init_physics_parameters, reset_world_or_sim):
        # rospy.logwarn("GAZEBO CONNECTION INIT ")
    ...
    def pauseSim(self):
        # rospy.logwarn("PAUSE SIMULATION ")
    ...
    def unpauseSim(self):
        # rospy.logwarn("UNPAUSE SIMULATION ")
    ...
    def init_physics_parameters(self):
        ...
        """
        # rospy.logwarn("INIT PHYSICS PARAMETERS")
    ...
    def update_gravity_call(self):
        ...
        # rospy.logwarn("Update Gravity call")
        self.pauseSim()
